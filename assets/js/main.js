...
// JavaScript for Image Switching with Enlarge Effect
document.querySelectorAll('.product-thumbnails img').forEach(function(thumbnail) {
    thumbnail.addEventListener('click', function() {
        ...
        // Add the enlarge effect class
        mainImage.classList.add('enlarged');

        // Remove the enlarge effect class after animation ends
        setTimeout(function() {
